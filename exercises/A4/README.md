...
As soon as the application has started, you'll find it listening for requests on port `8080`. To verify everything works as expected, issue the following command on the terminal (within the Vagrant box):
